...
const mockPosts = [
  {
    ...
    content: "오늘 쿠팡 체험단이라며 전화가 왔는데 A얼마?로 검사해보니 위험이라고 나왔어요. 다들 조심하세요!",
    likes: 24,
    comments: 5,
    tags: ["사기", "쿠팡", "체험단"],
  },
  {
    ...
    content: "최근 국민은행을 사칭한 문자들의 공통점을 정리해봤습니다. URL에 'kb' 대신 'kbbanking' 같은...",
    likes: 45,
    comments: 12,
    tags: ["금융", "은행", "패턴"],
  },
  {
    ...
    author: "박방패",
    date: "3시간 전",
    title: "부모님께 A얼마? 알려드리세요",
    content: "어르신들이 피싱에 취약하시잖아요. 저도 부모님 폰에 설치해드리고 사용법 알려드렸더니 좋아하세요!",
    likes: 89,
    comments: 23,
    tags: ["가족", "어르신", "공유"],
  },
      ...
      {!isLoggedIn && (
        <div className="fixed bottom-20 left-0 right-0 p-4 max-w-[430px] mx-auto">
          <div className="bg-orange-50 border border-orange-200 rounded-xl p-4 flex items-center justify-between">
            <p className="text-sm text-gray-700">로그인하고 글을 작성해보세요</p>
            <Link
              href="/login"
